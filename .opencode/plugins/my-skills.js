/**
 * My Skills plugin for OpenCode.ai
 *
 * Injects engineering-flow-lite bootstrap context via system prompt transform.
...
export const MySkillsPlugin = async ({ client, directory }) => {
  ...
  const getBootstrapContent = () => {
    ...
    // Try to load engineering-flow-lite skill
    const skillPath = path.join(mySkillsDir, 'engineering-flow-lite', 'SKILL.md');
...
**IMPORTANT: The engineering-flow-lite skill content is included below. It is ALREADY LOADED - you are currently following it. Do NOT use the skill tool to load "engineering-flow-lite" again - that would be redundant.**
...
${toolMapping}
  ...
  return {
    // Inject skills path into live config so OpenCode discovers My Skills
