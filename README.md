...
functional work gets written decisions, bugs get diagnosis before patches,
behavior changes get TDD, review feedback gets checked, and completion claims
need fresh evidence.
...
directory at this working tree. It checks routing decisions for docs, TDD,
diagnosis, review, verification, branch finish, architecture, and caveman
